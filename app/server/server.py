...
from darts_match_pb2 import VisitResponse, RegisterResponse, \
    FinalizeResponse, MatchResponse, \
    WatchResponse, Player, Dart
from darts_match_pb2_grpc import DartsMatchServicer, \
...
class DartServer(DartsMatchServicer):
    ...
    def __init__(self):
        ...
        self.factory.register_builder('X01', X01Match.X01MatchBuilder())
